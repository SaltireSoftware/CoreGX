...
'''
print("LaTeX:", data[0]["valueTex"], file=sys.stderr)
print("Expr:", expr, file=sys.stderr)
print("Symbols:", expr.free_symbols, file=sys.stderr)

d = sp.diff(expr, list(expr.free_symbols)[0])
print("Derivative:", d, file=sys.stderr)

print("Solve:", sp.solve(d), file=sys.stderr)
'''
